<div class="row">
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Feeding Schedule Form</h4>
                <form class="forms-sample" autocomplete="off" wire:submit.prevent="updateSchedule">   
                   
                    <div class="form-group">
                        <label for="herd_id">Herd</label>
                        <select wire:model.defer="state.feed_id" class="form-control @error('herd_id') is-invalid @enderror">
                     ...
                     <div class="form-group">
                        ...
                        <input type="date" wire:model.defer="state.start_date" id="start_date" class="form-control @error('start_date') is-invalid @enderror">
