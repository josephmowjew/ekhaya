...
<div class="row">
 ...
 <div class="mb-2 ml-3 d-flex justify-content-between">
    <a href="{{ route('ranch-manager.herds.create') }}">
      <button class="btn btn-primary "><i class="mdi mdi-plus-circle"></i> Add Herd</button>
    </a>
                    ...
                    <tbody wire:loading.class="text-muted">
                      @forelse($herds as $herd)
                         <tr>
                            ...
                            <td>
                              <a href="{{ route('ranch-manager.herds.edit',$herd) }}" >
                                <i class="mdi mdi-table-edit"></i> 
                              </a>
                              <a href="#" wire:click.prevent="confirmHerdRemoval({{ $herd->id }})">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" wire:click.prevent="deteleHerd" class="btn btn-danger"  >
