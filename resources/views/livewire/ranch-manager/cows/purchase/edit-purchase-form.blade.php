<div class="row">
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Purchase Record Form</h4>
                <form class="forms-sample" autocomplete="off" wire:submit.prevent="updatePurchase">   
                     ...
                     <div class="form-group">
                        ...
                        <select wire:model.defer="state.farmer_id" class="form-control @error('farmer_id') is-invalid @enderror">
                            ...
                            @foreach($farmers as $farmer)
                                <option value="{{ $farmer->id }}">{{ $farmer->firstName }}</option>
                            @endforeach
                        </select>
                            @error('farmer_id')
                            <div class="invalid-feedback">
