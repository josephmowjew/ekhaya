...
<div class="row">
 ...
 <div class="mb-2 ml-3 d-flex justify-content-between">
    <a href="{{ route('vaccination-expert.vaccines.create') }}">
      <button class="btn btn-primary "><i class="mdi mdi-plus-circle"></i> Add Vaccine</button>
    </a>
                    ...
                    <tbody wire:loading.class="text-muted">
                      @forelse($vaccines as $vaccine)
                         <tr>
                            ...
                            <td>
                              <a href="{{ route('vaccination-expert.vaccines.edit',$vaccine) }}" >
                                <i class="mdi mdi-table-edit"></i> 
                              </a>
                              <a href="#" wire:click.prevent="confirmVaccineRemoval({{ $vaccine->id }})">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" wire:click.prevent="deleteVaccine" class="btn btn-danger"  >
